            ...
            <li>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li><a href="/Seminers/{{$a->Year}}"></a></li>
                            @endif
                            @endforeach
                          </ul>
                        </div>
  ...
  <div class="carousel-inner">
      ...
      <div class="item">
          @if(Auth::check() && Auth::user()->hasRole('admin'))
              <a href="/DelImpImg/{{$img->id}}" style="position:absolute; top:2px;right:250px;"><i class="fa fa-times" aria-hidden="true" style=" color: #0D0A0A; background-color: #710909"></i></a>
