...
class="close" title="Close Modal">&times;</span>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <img id="im1" src="images/slo.png" alt=".....">
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      ...
      <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn" style="background:#003a5a;width:100px;margin:auto;margin-bottom:20px;">اغلاق</button>
